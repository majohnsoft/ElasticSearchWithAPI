...
namespace Smart.Business.Implementation
{
    public class PropertyServices : IPropertyServices
    {
        ...
        public PropertyServices(ConnectionSettings connectionSettings)
        {
        ...
        public async Task AddManyAsync(string indexName, List<PropertyObj> properties)
        {
        ...
        public async Task<ApiResponse<List<SearchResponseModel>>> SearchAsync(SearchRequestModel request)
        {
            ...
            {
                var searchResponse = await _elasticClient.SearchAsync<PropertyObj>(s => s
